...
public class ios extends HelperFuc{
    ...
    {
        try {
            driver = new RemoteWebDriver(new URL(URL), (Capabilities) setIoscap());
   ...
   @Test(priority =6)
    ...
    public static void SiginWith() throws IOException {
        ...
        try {
            driver.findElement(By.id("UserName")).clear();
            driver.findElement(By.id("Password")).clear();
            driver.findElement(By.id("UserName")).sendKeys("9970");//""+readExcel(5,0)
            driver.findElement(By.id("Password")).sendKeys("Nikhil@9315");//""+readExcel(5,1)
            driver.findElement(By.xpath("//input[@value=\"Sign in \"]")).click();
            Thread.sleep(5000);
            WriteExcel(8,8,"PASS");
        } catch (Exception e) {
    ...
    public static void ProjectIDMsg() throws IOException {
        try{
            ...
            String msg6= driver.findElement(By.xpath("//span[@data-valmsg-for=\"ProjectId\"][text()]")).getText();
    ...
    public static void durationUpdate() throws IOException {
        try{
            ...
            Thread.sleep(3000);
           for(int i=0;i<8;i++){
               driver.findElement(By.xpath("//a[@data-action=\"incrementHours\"]")).click();
           }
    ...
    public static void EditSheet() throws IOException {
        ...
        try {
            ...
            driver.findElement(By.xpath("//tr[2]//i[@class='glyphicon glyphicon-pencil']")).click();
